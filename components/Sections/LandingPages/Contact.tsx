    ...
    <div className="grid lg:grid-cols-2 gap-16 py-20 border-t border-neutral-100 dark:border-neutral-900">
      <div className="space-y-10">
        <div className="space-y-6">
          <h2 className="text-5xl md:text-6xl font-normal tracking-tight text-neutral-950 dark:text-neutral-50 leading-none">
            Let&apos;s <br /> Connect
            <span className="text-neutral-300 dark:text-neutral-700">.</span>
          </h2>
          <p className="text-lg md:text-xl text-neutral-500 dark:text-neutral-400 leading-relaxed font-light max-w-md">
        ...
        >
          <div className="p-4 rounded-full bg-neutral-800 dark:bg-neutral-100 group-hover:bg-green-500 transition-colors duration-500">
            <svg
              className="w-6 h-6 text-white dark:text-neutral-900 group-hover:text-white"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      <div className="space-y-8">
        <div className="text-xs font-normal uppercase tracking-[0.4em] text-neutral-400 dark:text-neutral-600 px-2">
          Digital Presence
        </div>
            ...
            >
              <div className="flex items-center gap-5">
                ...
                <div className="flex flex-col">
                  <span className="text-lg font-normal text-neutral-800 dark:text-neutral-200 tracking-tight">
                    {social.name}
                  </span>
                  <span className="text-xs font-normal uppercase tracking-widest text-neutral-400 group-hover:text-neutral-600 transition-colors">
                    {social.handle}
                  </span>
                </div>
              </div>
              <div className="w-10 h-10 rounded-full flex items-center justify-center bg-neutral-50 dark:bg-neutral-900 group-hover:bg-neutral-950 dark:group-hover:bg-white transition-all">
                <svg
                  className="w-4 h-4 text-neutral-300 dark:text-neutral-700 group-hover:text-white dark:group-hover:text-black group-hover:translate-x-0.5 transition-all"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
