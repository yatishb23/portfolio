    ...
    <div className="space-y-16">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-b border-neutral-200 dark:border-neutral-800 pb-8">
        <div className="space-y-1">
          ...
          <p className="text-neutral-500 dark:text-neutral-400 font-light font-sans">
            Professional journey and technical internships.
          </p>
        </div>
        <div className="text-xs font-normal uppercase tracking-widest text-neutral-400 dark:text-neutral-500 bg-neutral-100 dark:bg-neutral-900 px-4 py-2 rounded-full">
          2024 — 2026
        </div>
      </div>
        ...
        {[
          ...
          >
            <div className="lg:col-span-2">
              <span className="text-2xl font-light text-neutral-200 dark:text-neutral-800 group-hover:text-neutral-900 dark:group-hover:text-neutral-100 transition-colors duration-500 font-mono">
                {job.year}
              </span>
            </div>
            ...
            <div className="lg:col-span-7 space-y-4">
              <div>
                ...
                <div className="text-sm font-normal text-neutral-400 uppercase tracking-wider">
                  {job.company}
                </div>
              </div>
            ...
            <div className="lg:col-span-3 flex flex-wrap gap-2 lg:justify-end items-start content-start">
              {job.tech.map((tech) => (
                <span
                  key={tech}
                  className="px-2.5 py-1 text-xs font-normal uppercase tracking-tighter text-neutral-400 dark:text-neutral-500 bg-neutral-50 dark:bg-neutral-950 border border-neutral-100 dark:border-neutral-900 rounded group-hover:border-neutral-200 dark:group-hover:border-neutral-800 transition-colors"
                >
                  {tech}
                </span>
              ))}
